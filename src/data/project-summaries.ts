...
RGB Signatures are the identity system. Each signature is a unique binary visual encoding of an RGB value - your color, your mark. On RGB the app, your signature is your avatar. 16,777,216 possible identities, each one yours the moment you mint it.`,
  ...
  'RGB Friends': `RGB Friends is a CC0 generative pixel character collection - a collaboration between Internet Friends and RGB. The characters were built on top of the RGB color framework, each one a small figure rendered in a distinct RGB value.

The mint was free and open with no allowlists or presale. The collection was intentionally general - a shared canvas where communities could naturally form around it, rather than being built for a specific audience.

CC0 means no rights reserved. Anyone can use, remix, or build on RGB Friends without permission. Open and free forever.`,
