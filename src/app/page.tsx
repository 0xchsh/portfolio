      ...
      <div className="max-w-[900px] mx-auto px-5 sm:px-8 pt-12 pb-16">
        ...
        <div className="group/page flex flex-col desktop:grid desktop:grid-cols-[320px_320px] desktop:gap-x-16 desktop:items-start desktop:w-fit desktop:mx-auto">
          ...
          <V2LeftContent>
            ...
            {/* Bio */}
            <FadeIn delay={75}>
            <div className="text-sm leading-relaxed text-neutral-500 dark:text-neutral-400 flex flex-col gap-2 desktop:gap-3">
              <p>
            ...
            <section className="mt-8">
              ...
              <div className="mt-4 flex flex-col gap-2 desktop:gap-3">
          ...
          <div className="desktop:pt-5">
            ...
            <section className="mt-6 flex flex-col gap-2 desktop:gap-3">
