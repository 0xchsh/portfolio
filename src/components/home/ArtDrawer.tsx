                ...
                <p className="text-sm leading-5 font-semibold text-foreground">
                  ...
                  <span className="desktop:hidden relative inline-block ml-1" style={{ minWidth: '4rem' }}>
                    ...
                    <a
                      ...
                      className={`absolute left-0 top-0 inline-flex items-center whitespace-nowrap text-sm font-medium text-neutral-500 bg-neutral-100 dark:bg-neutral-800 px-2 py-0.5 rounded-full transition-opacity duration-500 ${showCollect ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
                    >
